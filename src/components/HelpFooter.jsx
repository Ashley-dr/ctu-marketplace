    ...
    <div className="max-w-full mb-32">
      <figure className="grid justify-items-center">
        <article className="mt-16 mb-16 ssm:mx-10 md:mx-0">
          <p id="helpcenter" className="text-3xl font-poppins mb-5">Help Center</p>
        ...
        <figure className="grid ssm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ssm:mx-5 lg:mx-10 lg:space-x-16 ">
          <article className="grid space-y-16 font-quicksand  ssm:w-72 md:w-96 lg:w-72">
            <article className="grid space-y-2">
              <p id="paymentm" className="font-poppins">Payment Methods</p>
            ...
            <article className="grid space-y-2">
              <p id="delivery" className="font-poppins">Delivery:</p>
              <p className="text-xs font-thin">
          ...
          <article className="grid space-y-16 font-quicksand ssm:w-72 md:w-96 lg:w-72">
            <article className="grid space-y-2">
              <p  id="howtoreturn"  className="font-poppins">How to Return an Item?</p>
              <ul className="text-xs font-thin space-y-1">
                <li>
        ...
        <article id="termscondition" className="mt-16  ssm:mx-10 md:mx-0 font-quicksand ">
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            <p className="text-xs ">
              ...
              CTU Danao community. By accessing our website, you agree to comply
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            <ul className="text-xs list-disc ml-6">
              <li>
                Registration: Only students, staff, and members of the CTU Danao
                community can register. Ensure your details are accurate.
              </li>
              <li>
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            <ul className="text-xs list-disc ml-6">
              <li>
                Prohibited Conduct: Do not engage in fraudulent activities, sell
                prohibited items, or harass other users. Misuse of the platform
                for illegal activities is strictly prohibited.
              </li>
              <li>
                Content Standards: Ensure all content you post is accurate, does
                not infringe on intellectual property rights, and is appropriate
                for the community.
              </li>
            </ul>
          </article>
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            <ul className="text-xs list-disc ml-6">
              ...
              <li>
                ...
                services, and communicate with you regarding your transactions.
              </li>
              <li>
                Data Protection: We implement security measures to protect your
                information from unauthorized access, including encryption and
                secure servers.
              </li>
              <li>
                Your Rights: You can access, update, or delete your personal
                information by contacting us at support@cebutechmarketplace.com.
              </li>
            </ul>
          </article>
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            <ul className="text-xs list-disc ml-6">
              <li>
                ...
                property rights of others. Unauthorized selling or uploading of
                counterfeit products is prohibited.
              </li>
              <li>
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            <ul className="text-xs list-disc ml-6">
              <li>
                ...
                loss or damage resulting from the use of the platform. Users are
                responsible for their transactions.
              </li>
              <li>
                Indemnification: You agree to indemnify and hold harmless Cebu
                Tech Marketplace from any claims arising out of your use of the
                platform.
              </li>
            </ul>
          </article>
        ...
        <article id="useraggrement" className="mt-16  ssm:mx-10 md:mx-0 font-quicksand ">
        ...
        <p className="text-3xl font-poppins mb-5 text-center">
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            <p className="text-xs justify-self-center">
              ...
              use our site, you must agree to the following guidelines and terms
              of use. Your adherence to these rules is essential for maintaining
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            <p className="text-xs ">
              ...
              login credentials. Sharing your account or using someone else's
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            <p className="text-xs ">
            Users must provide accurate and truthful information when registering and using the site. Misrepresentation or false information is prohibited.
            </p>
          </article>
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            <p className="text-xl">4. Content Guidelines:</p>
            <p className="text-xs ">
            All content, including posts, comments, and uploaded media, must be appropriate and relevant to the community. Prohibited content includes but is not limited to:
            <p><li>Offensive or abusive language</li>
            <li>Inappropriate or explicit material</li>
            <li>Spam or unauthorized advertisements</li>
            <li>Content that violates any laws or regulations</li></p>
                </p>
          </article>
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            <p className="text-xl">5. Transaction Integrity:</p>
            <p className="text-xs ">
            All transactions conducted on the site must be fair and honest. Any fraudulent or deceitful activities are strictly forbidden.
            </p>
          </article>
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
          ...
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            <p className="text-xs ">
            Failure to adhere to the guidelines and terms of use will result in the following sanctions:
            </p>
            </article>
            <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            The user will be required to perform community service within the school.
            </p>
          </article>
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
            ...
            The user will receive a 0.5 addition to their grades (e.g., if your grade is 1.5, it will be increased to 2.0).
            </p>
          </article>
          <article className="grid mb-5 ssm:mx-2 lg:mx-10  space-y-2">
